...
pub fn equidistance_sphere(num : u16 ) -> SphericalAxes {
    // Set a value as surface area / points
    let corrected_num: f32 = corrected_amount_of_points(num as f32);
    let a: f32 = ( 4. * PI * RHO.powi(2)) / corrected_num;
...
fn corrected_num_amount_to_size_up_arrays(m_theta : f32, d_phi : f32) -> usize {
